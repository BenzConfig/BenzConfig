...
> ⚠️ **Важно:** Если вы запускаете стандартную версию приложения, на вашем компьютере должен быть установлен [** .NET Desktop Runtime 8.0**](https://dotnet.microsoft.com/ru-ru/download/dotnet/thank-you/runtime-8.0.30-windows-x64-installer). Если вы используете автономную версию (Self-contained), дополнительно ничего устанавливать не нужно.
